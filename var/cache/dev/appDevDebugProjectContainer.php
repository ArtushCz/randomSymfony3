...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9' => 'get157073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9Service',
            '2_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9' => 'get257073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9Service',
            ...
            'security.user.provider.concrete.ours_database_users' => 'getSecurity_User_Provider_Concrete_OursDatabaseUsersService',
        ...
        $this->privates = array(
            '1_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9' => true,
            '2_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9' => true,
            ...
            'security.user.provider.concrete.ours_database_users' => true,
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EventBundle', ($this->targetDirs[3].'\\app/Resources/EventBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EventBundle', ($this->targetDirs[3].'\\src\\EventBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9']) ? $this->services['1_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9'] : $this->get157073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9']) ? $this->services['2_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9'] : $this->get257073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\EventBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')));
        ...
        $d->setEntityNamespaces(array('EventBundle' => 'EventBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_681f3c10d3eafb6deca652cb4d50fe8b5201fc1b764a5e19d830c03941416d37');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, 'event_index'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
        ...
        $k->setOptions(array('login_path' => 'login_form', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $l->setOptions(array('login_path' => 'login_form', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.ours_database_users']) ? $this->services['security.user.provider.concrete.ours_database_users'] : $this->getSecurity_User_Provider_Concrete_OursDatabaseUsersService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'main', $k, $l, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5a09e5af84d945.58317976', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $h, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $i, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $i, 'login_form', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.ours_database_users', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, ${($_ = isset($this->services['templating.name_parser']) ? $this->services['templating.name_parser'] : $this->get('templating.name_parser')) && false ?: '_'}, true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AsseticBundle', 8 => 'EventBundle', 9 => 'UserBundle', 10 => 'DebugBundle', 11 => 'WebProfilerBundle', 12 => 'SensioDistributionBundle', 13 => 'DoctrineFixturesBundle', 14 => 'SensioGeneratorBundle', 15 => 'WebServerBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    /**
     * Gets the private '1_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get157073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9Service()
    {
        return $this->services['1_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get257073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9Service()
    {
        return $this->services['2_57073c825efb6603784319af9bcfcc167e17bf7e169f48f8eee132abfe17ebc9'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Pe0HfUGFg8', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5pl2sNJI2t', 0, 'vXhD-xt6qqdM6FJCC9ZpeK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yxpnLbvuVP', 0, 'vXhD-xt6qqdM6FJCC9ZpeK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zqOKXthRzJ', 0, 'vXhD-xt6qqdM6FJCC9ZpeK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a09e5af84d945.58317976');
    }
    ...
    {
        return $this->services['security.authentication.provider.dao.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.ours_database_users']) ? $this->services['security.user.provider.concrete.ours_database_users'] : $this->getSecurity_User_Provider_Concrete_OursDatabaseUsersService()) && false ?: '_'}, new \Symfony\Component\Security\Core\User\UserChecker(), 'main', ${($_ = isset($this->services['security.encoder_factory']) ? $this->services['security.encoder_factory'] : $this->get('security.encoder_factory')) && false ?: '_'}, true);
    }
    ...
    /**
     * Gets the private 'security.user.provider.concrete.ours_database_users' shared service.
     *
     * @return \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider
     */
    protected function getSecurity_User_Provider_Concrete_OursDatabaseUsersService()
    {
        return $this->services['security.user.provider.concrete.ours_database_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, 'UserBundle:User', NULL, NULL);
    }
