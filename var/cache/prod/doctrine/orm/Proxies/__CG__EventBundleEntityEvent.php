...
class Event extends \EventBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'name', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'time', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'location', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'details'];
        }
